...
<body>
	<div class="house_seperate_setting_wrap">		
		<div class="house_seperate_addButton_wrap">
			<ul class="house_seperate_button_list">
				<li>
					<span class="yj_button house_seperate_back">back</span>
				</li>
				<li>
					<span class="yj_button house_seperate_addButton" data-seq="${seq }">seperate</span>
				</li>
			</ul>
		</div>
			<table class="house_seperate_table">
			<colgroup>
				<col width="10%">
				<col width="10%">
				<col width="10%">
