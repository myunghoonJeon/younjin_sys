...
<body>
	<div id="addtional_decide_wrap">
		...
		<div class="yj_button_wrap">
			<ul class="yj_button_list inbound_final_back_wrap">
				<li>
					<span class="yj_button inbound_final_back">back</span>
				</li>
			</ul>
		</div>
			...
			<table id="addition_table" data-seq="${seq}">
				...
				<tfoot>
					<tr>
						<td colspan="2">
							<div>
								<span class="inbound_addition_complete_btn yj_button">complete</span>
							</div>
						</td>
					</tr>
				</tfoot>
