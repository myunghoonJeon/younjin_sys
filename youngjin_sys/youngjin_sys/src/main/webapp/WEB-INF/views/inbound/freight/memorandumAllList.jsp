...
<body>
	<div class="memorandum_all_list_wrap" data-seq="${seq}">
		...
		<div id="memorandum_all_addButton" class="inbound_memorandum_all_addButton">
			<ul id="memorandum_all_button_list">
				<li>
					<span class="yj_button memorandum_all_back" id="inbound_memorandum_all_back">back</span>
				</li>
				<li>
					<span class= "yj_button memorandum_all_addButton" id="inbound_memorandum_all_addButton">add</span>
				</li>
			</ul>
		</div>
		<div>
			<table id="inbound_all_table" class="yj_table memorandum_all_table" data-seq="${seq }">
				<thead>
					<tr>
						<th>
							NO
				...
				<tbody>
					...
					<c:forEach var="memorandum" items="${memroandumList }" varStatus="i">
						<tr data-list="${memorandum.seq }">
							...
							<td data-check="delete"><img class="memorandum_icon inbound_memorandum_list_delete" src="${cp }/resources/images/gbl/memorandum_delete.png" /></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
