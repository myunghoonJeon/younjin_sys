	...
	<div class="memorandum_wrap">
		...
		<div class="yj_button_wrap">
			<ul class="yj_button_list">
				<li>
					<span id="inbound_memo_back_button" class="yj_button memo_back_button">back</span>
				</li>
			</ul>
		</div>
		<div>
							...
							<td class="memorandum_icon_wrap">
								<ul>
									<c:if test="${checkMemorandumMap[memorandum.subCode] eq null}">
										<li><img class="memorandum_icon inbound_memorandum_input_subButton" src="${cp }/resources/images/gbl/memorandum_add.png" /></li>
									</c:if>
									...
									<c:if test="${checkMemorandumMap[memorandum.subCode] ne null and memorandum.subCode ne '04' and memorandum.subCode ne '05' and memorandum.subCode ne '06' and memorandum.subCode ne '07' and memorandum.subCode ne '08'}">
